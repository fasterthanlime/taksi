...
HRESULT CTaksiDX8::RestoreDeviceObjects()
{
...
HRESULT CTaksiDX8::InvalidateDeviceObjects(bool bDetaching)
{
	// Desc: Destroys all device-dependent objects
	DEBUG_MSG(("CTaksiDX8::InvalidateDeviceObjects: called."));
	...
	DEBUG_MSG(( "CTaksiDX8::InvalidateDeviceObjects: done." LOG_CR));
    return S_OK;
}

//*********************************************************************

HWND CTaksiDX8::GetFrameInfo( SIZE& rSize ) // virtual
{
...
HRESULT CTaksiDX8::GetFrame( CVideoFrame& frame, bool bHalfSize )
{
	// check dest.surface format
	switch(s_bbFormat)
	{
	...
	CLOCK_STOP(c,"CTaksiDX8::GetFrame*Size clock=%10d");
