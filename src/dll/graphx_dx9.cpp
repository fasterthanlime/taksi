...
HRESULT CTaksiDX9::RestoreDeviceObjects()
{
...
HRESULT CTaksiDX9::GetFrame( CVideoFrame& frame, bool bHalfSize )
{
	// check dest.surface format
	switch (s_bbFormat)
	{
...
void CTaksiDX9::FreeDll()
{
	...
	DEBUG_MSG(( "CTaksiDX9::FreeDll: done." LOG_CR));
	__super::FreeDll();
}
